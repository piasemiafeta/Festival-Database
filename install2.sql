...
CREATE INDEX idx_event_date ON event (event_date, festival_year);
CREATE INDEX idx_staff_role ON staff (staff_role);
CREATE INDEX idx_artist_name ON artist (first_name, surname);
CREATE INDEX idx_band_genre ON band (genre_name, subgenre_name);
CREATE INDEX idx_performance_artist ON performance (artist_id);
CREATE INDEX idx_performance_event ON performance (event_id);
CREATE INDEX idx_performance_band ON performance (band_name);
CREATE INDEX idx_performance_artist_status ON performance (artist_status);
CREATE INDEX idx_performance_type ON performance (performance_type);
CREATE INDEX idx_visitor ON visitor (first_name, surname, email);
CREATE INDEX idx_ticket_visitor ON ticket (visitor_id);
CREATE INDEX idx_ticket_event ON ticket (event_id);
CREATE INDEX idx_ticket_type ON ticket (purchase_type);
CREATE INDEX idx_rating_visitor ON rating (visitor_id);
